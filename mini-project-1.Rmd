...
The `release_date` column is formated as string. I decided to format it into date to make it easier to analyze.
...
Now that it is correctly formated, dividing release date into categories might help analyzing this variable later.
...
Now that it is correctly formated, dividing number of reviews into categories might help analyzing this variable later.
