...
Do note that the other "string" columns could be parsed into new variables but it is not so clear how to do so. For instance, there are `r unique_popular_tags_count` unique popular tags in the `popular_tags` column. I don't think it would be helpful for the analysis.
